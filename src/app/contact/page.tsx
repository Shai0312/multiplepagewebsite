...
export default function Contact(){
    return(
        <div className="mt-20 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg">
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    <h1 className="text-4xl font-bold text-white">Get in Touch</h1>
                    <p className="text-sm text-gray-300 mt-4 leading-relaxed">Your dream cake is just a message away!Whether it &apos;s a birthday,wedding,or just a sweet craving, we &apos;re ready to bake happiness for you. Connect with us today and let &apos;s create magic together!</p>
                ...
                <div className="bg-gray-100 p-6 rounded-lg">
                    ...
                    <form className="mt-8 space-y-4">
                        <input type='text' placeholder='Name'
                            className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-pink-600" />
                        <input type='email' placeholder='Email'
                            className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-pink-600" />
                        <input type='text' placeholder='Subject'
                            className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-pink-600" />
                        <textarea placeholder='Message' rows={6}
                            className="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-pink-600"></textarea>
                        <button type='button'
                            className="text-white bg-pink-600 hover:bg-pink-500 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
